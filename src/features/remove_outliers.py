...
# Interquartile Range (distribution-based method)
...
# Chauvenet's criterion (distribution-based method)
...
# Local Outlier factor (distance-based method)
# LOF function
...
# choose method and columns to remove outliers

# Test on the single column
...
for col in outlier_columns:
     for label in df["label"].unique():
        ...
        # Replace values with outliers marked as True with NaN
        dataset.loc[dataset[col + "_outlier"], col] = np.nan
        
        # Update the original dataframe with the outliers removed for the current label
